# Rekonsiliasi Data POS & Magento

Aplikasi web client-side (murni offline tanpa server) untuk mengotomasi proses rekonsiliasi data transaksi dan profil member antara sistem POS (Kasir) dan sistem Magento.

## Fitur Utama

### 1. Rekonsiliasi Transaksi POS & Magento
...
### 2. Rekonsiliasi Data Member POS & Magento
